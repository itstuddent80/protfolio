...
export function Education() {
  ...
  const education = [
    ...
    {
      degree: '10th SEE',
      institution: 'Shanti Nikunj Boarding School',
      location: 'Golbazar',
      period: '2022',
      current: false,
    },
  ...
  return (
    <section id="education" className={`py-20 px-4 sm:px-6 lg:px-8 ${isDark ? 'bg-slate-900/50' : 'bg-slate-100'}`} ref={ref}>
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className={`text-4xl md:text-5xl mb-4 ${isDark ? 'text-white' : 'text-slate-900'}`}>Education</h2>
                  ...
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className={`text-xl mb-1 ${isDark ? 'text-white' : 'text-slate-900'}`}>{edu.degree}</h3>
